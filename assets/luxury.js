...
(function () {
  ...
  // ══════════════════════════════
  // S. WHATSAPP FLOATING BUTTON
  // ══════════════════════════════
  function initWhatsApp() {
    if (document.getElementById('wa-float')) return;
    const phone = '16135550199'; // Ottawa — à remplacer par le vrai numéro
    const msgFr = encodeURIComponent('Bonjour Halo Braids ! Je souhaite avoir plus d\'informations sur vos services.');
    const msgEn = encodeURIComponent('Hello Halo Braids! I would like more information about your services.');
    const lang = (typeof App !== 'undefined' ? App.lang : 'fr');
    const msg = lang === 'en' ? msgEn : msgFr;
